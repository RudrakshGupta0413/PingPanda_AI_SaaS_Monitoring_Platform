...
const Page = () => {
  ...
  return (
    <>
          ...
          <div className="relative mx-auto text-center flex flex-col items-center gap-10">
            <div>
              <Heading>
                ...
                <br />
                <span className="relative bg-gradient-to-r from-blue-600 to-blue-800 text-transparent bg-clip-text">
      ...
      <section className="relative bg-blue-25 pb-4">
          ...
          <MaxWidthWrapper className="relative">
            <div className="-m-2 rounded-xl bg-gray-900/5 p-2 ring-1 ring-inset ring-gray-900/10 lg:rounded-2xl lg:p-4">
              <MockDiscordUI>
                <AnimatedList>
                  <DiscordMessage
                    avatarSrc="/brand-asset-profile-picture-3.jpg"
                  ...
                  />
                  <DiscordMessage
                    avatarSrc="/brand-asset-profile-picture-2.jpg"
                    avatarAlt="PingPanda Avatar"
                    username="PingPanda"
                    timestamp="Today at 14:15PM"
                    badgeText="Revenue"
                    badgeColor="#43b581"
                    title="💰 Payment Received"
                    content={{
                      amount: "$79.00",
                      email: "zod.fernandez@gmail.com",
                      plan: "Pro Plan",
                    }}
                  />
                  <DiscordMessage
                    ...
                    avatarAlt="PingPanda Avatar"
                    username="PingPanda"
                    timestamp="Today at 5:26AM"
                    badgeText="Milestone"
                    badgeColor="#4f5be0"
                    title="🚀 Revenue Milestone Achieved"
                    content={{
                      recurringRevenue: "$23.00 USD",
                      growth: "+5.2%",
                    }}
                  />
                </AnimatedList>
      ...
      <section className="relative py-24 sm:py-32 bg-brand-25">
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-20">
          ...
          <div className="grid gap-4 lg:grid-cols-3 lg:grid-rows-2">
            {/* first bento grid component */}
            <div className="relative lg:row-span-2">
              <div className="absolute inset-px rounded-lg bg-white lg:rounded-l-[2rem]" />

              <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(borderRadius.lg)+1px] lg:rounded-l-[cals(2rem+1px)]">
                <div className="px-8 pb-3 pt-8 sm:px-10 sm:pb-0 sm:pt-10">
                  <p className="mt-2 text-lg/7 font-medium tracking-tight text-blue-950 max-lg:text-center">
                    Real-time notifoications
                  </p>
            ...
            <div className="relative max-lg:row-start-3 lg:col-start-2 lg:row-start-2">
              ...
              <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)]">
                <div className="mt-2 pt-8 sm:px-10 sm:pt-10">
                  <p className="mt-2 text-lg/7 font-medium tracking-tight text-blue-950 max-lg:text-center">
            ...
            <div className="relative lg:row-span-2">
              ...
              <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] max-lg:rounded-b-[calc(2rem+1px)] lg:rounded-r-[calc(2rem+1px)]">
                ...
                <div className="relative min-h-[30rem] w-full grow">
                  <div className="absolute bottom-0 left-10 right-0 top-10 overflow-hidden ro0unded-tl-xl bg-gray-900 shadow-2xl">
      ...
      <section className="relative py-24 sm:py-32 bg-white">
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-20">
          ...
          <div className="mx-auto grid max-w-2xl grid-cols-1 px-4 lg:mx-8 lg:max-w-none lg:grid-cols-2 divide-y lg:divide-y-0 lg:divide-x divide-gray-200">
            ...
            <div className="flex flex-auto flex-col gap-4 bg-brand-50 p-6 sm:p-8 lg:p-16 rounded-t-[2rem] lg:rounded-tr-none lg:rounded-l-[2rem]">
              ...
              <div className="flex flex-col justify-center lg:justify-start sm:flex-row items-center sm:items-start gap-4 mt-2">
                ...
                <div className="flex flex-col items-center sm:items-start">
                  <p className="font-semibold flex items-center text-blue-950">
                    Sarah Gonzalez
                    <Icons.verificationBadge className="size-4 inline-block ml-1.5" />
                  </p>
                  <p className="text-sm text-gray-600">@itsmateo</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-auto flex-col gap-4 bg-brand-50 p-6 sm:p-8 lg:p-16 rounded-b-[2rem] lg:rounded-bl-none lg:rounded-r-[2rem]">
              ...
              <div className="flex flex-col justify-center lg:justify-start sm:flex-row items-center sm:items-start gap-4 mt-2">
                ...
                <div className="flex flex-col items-center sm:items-start">
                  ...
                  <p className="text-sm text-gray-600">@itsdavid</p>
                </div>
              </div>
            </div>
          </div>
