...
const Page = () => {
  ...
  const INCLUDED_FEATURES = [
    ...
    "10 event categories",
    "Adavnced analytics and insights",
    "Priority support",
  ]
  ...
  return (
    <div className="bg-blue-25 py-24 sm:py-32">
      <MaxWidthWrapper>
        <div className="mx-auto max-w-2xl sm:text-center">
          ...
          <p className="mt-6 text-base/7 text-gray-600 max-w-prose text-center text-pretty">
            We hate subscriptions. And chances are, you do too. That&aposs;s why
        ...
        <div className="bg-white mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
          <div className="p-8 sm:p-10 lg:flex-auto">
            ...
            <p className="mt- text-base/7 text-gray-600">
