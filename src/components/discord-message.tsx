...
type BadgeColor = "#43b581" | "#faa61a" | "#4f5be0" | (string & {})
    ...
    <div className="w-full flex items-start justify-start">
      ...
      <div className="w-full max-w-xl">
        <div className="flex items-center">
          ...
          <span className="ml-2 px-1.5 py-0.5 text-xs font-semibold text-white bg-blue-600 rounded">
            APP
          </span>
        ...
        <div className="bg-[#2f3136] text-sm w-full rounded p-3 mb-4 mt-1.5">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-2">
            {badgeText ? (
              <span
                className={cn(
                  "inline-flex items-center order-2 rounded-md px-2 py-1 text-sm font-medium ring-1 ring-inset",
