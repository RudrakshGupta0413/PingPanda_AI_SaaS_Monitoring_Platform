      ...
      <div className="hidden md:flex w-60 bg-[#2f3136] flex-col">
        ...
        <div className="flex-1 overflow-y-auto pt-4">
          ...
          <div className="px-2 mb-4">
            ...
            <div className="flex items-center px-2 py-1.5 rou ded bg-[#393c43] text-white cursor-pointer">
              <Image
          ...
          <div className="flex items-center">
            <div className="relative">
              <Image
                ...
                className="object-cover rounded-full mr-3"
              />
              <div className="absolute bottom-0 right-3 size-3 bg-green-500 rounded-full border-2 border-[#363c3f]" />
            </div>
