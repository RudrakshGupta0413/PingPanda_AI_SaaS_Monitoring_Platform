    ...
    >
      <div className="flex flex-col items-center">
        {isPending || !isPaymentSuccessful ? (
          ...
          <>
            <div className="reltaive aspect-video border border-gray-200 w-full overflow-hidden rounded-lg bg-gray-50">
              <img
      ...
      <div className="mt-6 flex flex-col items-center gap-1 text-center">
        ...
        Thank you for upgrading to Pro and suporting is PingPanda. Your accunt has been upgraded.</p>
      </div>
